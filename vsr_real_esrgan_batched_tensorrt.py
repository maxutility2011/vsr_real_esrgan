...
def preprocess_batch(images, target_shape):
    ...
    for img in images:
        ...
        print("img_transposed shape: ", img_resized.shape)
...
#host_output = np.zeros(batch_size * 3 * 128 * upscale_factor * 128 * upscale_factor, outputs[0]['dtype']) # Allocate output buffer
...
#output_images = host_output.reshape((batch_size, 3, 128 * upscale_factor, 128 * upscale_factor))
